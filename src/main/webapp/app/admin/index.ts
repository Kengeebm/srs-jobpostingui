...
export * from 'app/admin/data-config-management/data-config-management.component';
export * from 'app/admin/data-config-management/data-config-management.route';
